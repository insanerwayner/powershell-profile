...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid>
        ...
        <Image
            ...
            Source="\\ccmhmr\sysvol\ccmhmr.local\Policies\{A3834D64-ED46-4D4B-9B2E-8CC22B0B057B}\User\Scripts\Logon\Lifepath Logo.png"
        />
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Background="White"
        BorderThickness="30"
        AllowsTransparency="True" ResizeMode="NoResize" Topmost="True" ShowInTaskbar="False"
        >
    <Grid>
        <Grid.RowDefinitions>
...
Function Load-XAML ( $days )
	...
	$buttonclose = {Start-Process explorer.exe;$Form.close()}
	$OkayBTN.add_Click($buttonclose)
...
try
	...
	$username = [Environment]::UserName
	$searcher=New-Object DirectoryServices.DirectorySearcher
	$searcher.Filter="(&(samaccountname=lparsons)(!(userAccountControl:1.2.840.113556.1.4.803:=65536)))"
	$results=$searcher.findone()
	$lastset = [datetime]::fromfiletime($results.properties.pwdlastset[0])
	$timeleft = 90 - ( ( Get-Date ) - $lastset ).days
	}
